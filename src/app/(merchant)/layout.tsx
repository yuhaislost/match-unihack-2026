	...
	return (
		<div className="flex min-h-dvh flex-col">
			...
			<nav className="fixed bottom-0 left-1/2 flex h-14 w-full max-w-[var(--viewport-max)] -translate-x-1/2 items-center justify-around border-t border-border bg-background safe-area-bottom">
				<a href="/dashboard" className="text-small-medium text-text-secondary hover:text-text-primary">
					Dashboard
				</a>
				<a href="/courts" className="text-small-medium text-text-secondary hover:text-text-primary">
					Courts
				</a>
				<a href="/upsells" className="text-small-medium text-text-secondary hover:text-text-primary">
					Upsells
				</a>
			</nav>
		</div>
